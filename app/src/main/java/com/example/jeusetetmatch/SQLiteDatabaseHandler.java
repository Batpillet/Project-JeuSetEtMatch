...
public class SQLiteDatabaseHandler extends SQLiteOpenHelper {
    ...
    public void addMatch(Match m) {
        ...
        values.put(KEY_SET1J2, m.getJoueur2().getJeu().get(0));
        values.put(KEY_SET2J2, m.getJoueur2().getJeu().get(1));
        values.put(KEY_SET3J2, m.getJoueur2().getJeu().get(2));
...
*/
    ...
    public Integer deleteMatch(String id) {
        ...
        //db.execSQL("DELETE FROM tablematch WHERE _id='"+id+"'");
    }
